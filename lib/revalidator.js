(function (exports) {
  ...
  function schemaHasType(schema, type) {
     ...
     * Also needs to support array types, though behaviour is undefined
  ...
  function cast(value, schema) {
    // If the value can be null, and it is null-ish, dont cast
    if (schemaHasType(schema, 'null') && !value){
        return null;
    }
